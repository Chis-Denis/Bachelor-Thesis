...
class MealFormControllers {
  ...
  final ValueNotifier<MealType> type;
  ...
  MealFormControllers({
    ...
    TimeOfDay? time,
        ...
        type = ValueNotifier<MealType>(type),
...
class _TypeField extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    return ValueListenableBuilder<MealType>(
      valueListenable: type,
      builder: (context, value, _) {
        return DropdownButtonFormField<MealType>(
          initialValue: value,
          onChanged: enabled ? (v) => type.value = v ?? value : null,
    ...
    return ValueListenableBuilder<String>(
      ...
      builder: (context, value, _) {
        ...
        return DropdownButtonFormField<String>(
          initialValue: value,
          isExpanded: true,
          onChanged: enabled ? (v) => unit.value = v ?? value : null,
          decoration: const InputDecoration(labelText: 'Unit'),
          items: [
            for (final u in items) DropdownMenuItem(value: u, child: Text(u)),
          ],
        );
      },
    );
